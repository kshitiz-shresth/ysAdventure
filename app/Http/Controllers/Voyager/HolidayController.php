...
class HolidayController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $dataTypeContent = \App\Holiday::where('country_id',\App\Country::where('slug',$request->country)->first()->id)->orderBy('order')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/admin/holidays?country='.\App\Country::find($request->country_id)->slug)->with([
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->has('_tagging')) {
            if (auth()->user()->can('browse', $data)) {
                $redirect = redirect()->route("voyager.{$dataType->slug}.index")."?aa";
            } else {
                $redirect = redirect()->back();
            }
    ...
    public function order(Request $request)
    {
        ...
        // changed
        $results = $model->where('country_id',\App\Country::where('slug',$request->country)->first()->id)->orderBy($dataType->order_column, $dataType->order_direction)->get();
